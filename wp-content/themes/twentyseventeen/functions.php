...
function twentyseventeen_scripts() {
   ...
   // wp_enqueue_style('custom', get_template_directory_uri() . '/css/custom.css', array(), '1.0', 'all');
    ...
    wp_enqueue_script('plugin-compilation', get_template_directory_uri() . '/js/plugin-compilation.js', array() );
    wp_enqueue_script('fonts', 'https://use.typekit.net/ylo4knr.js', array() );
    wp_enqueue_script('custom-js', get_template_directory_uri() . '/js/custom.js', array() );
    wp_enqueue_script('backstretch', get_template_directory_uri() . '/js/back.js', array() );
